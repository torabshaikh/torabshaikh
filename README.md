[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&width=435&lines=Hi%2C+I'm+Mo+Torab+Shaikh!+👋;My+areas+of+interests+are;-+Edge+Computing;-+Computer+Vision;-+Robotics+Software+Engineering;-+Full+Stack+Development;-+Cloud+Computing)](https://git.io/typing-svg)

### More about me!

Senior Engineer & Ex-Tech Lead. Coming from a startup background, I build practical, high-performance systems. I combined my industry experience in IoT/EdgeAI/Cloud/Web with an M.S. in Robotics to specialize in Edge AI, Machine Learning, CUDA, and Computer Vision. My current focus is to build fast and efficient systems on resource-constrained hardware.
